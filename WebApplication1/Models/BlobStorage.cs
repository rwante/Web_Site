...
namespace WebApplication1.Models
{
    public class BlobStorage : IBlobStorage
    {
        ...
        public BlobStorage()
        {
            _blobServiceClient = new BlobServiceClient("DefaultEndpointsProtocol=https;AccountName=kayipesyablob;AccountKey=Tmc/YSLsBQz//xSDJyMqXhgsF2eATmGGa78uc5H6zoKW3LVsPDo8CzSZrFWlawv1ibU+a/ikU6yckfBacvdVlA==;EndpointSuffix=core.windows.net");
        }
